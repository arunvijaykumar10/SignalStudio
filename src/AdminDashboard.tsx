...
import { Search, Bell, Menu, Settings, User, ChevronDown, Users, FileText, BarChart4, CheckCircle, Zap, AlertTriangle, Clock, RefreshCw, RotateCcw, Calendar, Image, Brain, X, ExternalLink } from 'lucide-react';
        ...
        <main className="flex-1 p-6">
          <div className="max-w-7xl mx-auto">
            <div className="flex justify-between items-center mb-6">
              <h1 className="text-2xl font-bold text-gray-900">System Overview Panel</h1>
            ...
            <div className="w-full p-6 bg-white rounded-lg shadow">
              <h2 className="text-xl font-bold mb-6 text-gray-800">System Overview</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
                ...
                <div className="bg-blue-50 p-4 rounded-lg border border-blue-100 shadow-sm">
                  <div className="flex justify-between items-start">
                    <div>
                      <p className="text-sm font-medium text-blue-600">Active Users (30 days)</p>
                      <h3 className="text-2xl font-bold mt-1">28</h3>
                      <p className="text-xs text-blue-700 mt-1">+14% from last month</p>
                    </div>
                ...
                <div className="bg-green-50 p-4 rounded-lg border border-green-100 shadow-sm">
                  <div className="flex justify-between items-start">
                    <div>
                      <p className="text-sm font-medium text-green-600">Drafts Created (This Month)</p>
                ...
                <div className="bg-purple-50 p-4 rounded-lg border border-purple-100 shadow-sm">
                  <div className="flex justify-between items-start">
                    <div>
                      <p className="text-sm font-medium text-purple-600">Avg. Tone Score</p>
                ...
                <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-100 shadow-sm">
                  <div className="flex justify-between items-start">
                    <div>
                      <p className="text-sm font-medium text-yellow-600">Export Success Rate</p>
                ...
                <div className="bg-red-50 p-4 rounded-lg border border-red-100 shadow-sm">
                  <div className="flex justify-between items-start">
                    <div>
                      <p className="text-sm font-medium text-red-600">Top Module Usage</p>
                      <h3 className="text-lg font-bold mt-1">Structured Draft Editor</h3>
                      <p className="text-xs text-red-700 mt-1">386 uses this month</p>
                    </div>
            ...
            <div className="w-full p-6 bg-white rounded-lg shadow mt-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="font-medium text-gray-700">Error Count (Today)</p>
                        <div className="flex space-x-4 text-sm">
                          <span className="text-amber-600">2 failed exports</span>
                ...
                <div className="space-y-4">
                  {/* Latency Graph */}
                  <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    <p className="font-medium text-gray-700 mb-2">Latency Graph (last 24h)</p>
                    <div className="h-12 w-full bg-white rounded border border-gray-200 overflow-hidden">
                      ...
                      <div className="flex items-end h-full w-full pl-1 pr-1 pt-1 space-x-1">
                        {[40, 35, 45, 30, 25, 35, 40, 38, 45, 50, 55, 45, 40, 42, 40, 38, 42, 40, 38, 35].map((height, i) => (
                          <div 
                            key={i} 
                    ...
                    <p className="text-xs text-gray-500 mt-1">Avg. response time: 280ms</p>
                  </div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="font-medium text-gray-700">Last Sync (Integrations)</p>
                        <div className="flex flex-col space-y-1 text-sm">
                          <span className="text-gray-600">CMS sync completed 5 mins ago</span>
                          <span className="text-gray-600">Slack notifications working normally</span>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="w-full p-6 bg-white rounded-lg shadow mt-6">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-bold text-gray-800">Recent Platform Changes</h2>
              ...
              <div className="space-y-4">
                ...
                <div className="flex">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 flex-grow">
                    <div className="flex justify-between">
                      <h3 className="font-medium text-gray-800">Validator rules updated</h3>
                      <div className="text-sm text-gray-500">Today, 10:42 AM</div>
                    </div>
                    <p className="text-sm text-gray-600 mt-1">Memory Zone → Governance Center</p>
                    <div className="flex items-center text-sm text-gray-600 mt-2">
                      <img src="/api/placeholder/32/32" alt="User" className="h-5 w-5 rounded-full mr-2" />
                ...
                <div className="flex">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 flex-grow">
                    <div className="flex justify-between">
                      <h3 className="font-medium text-gray-800">New prompt templates added</h3>
                      <div className="text-sm text-gray-500">Today, 09:15 AM</div>
                    </div>
                    <p className="text-sm text-gray-600 mt-1">Memory Zone → Prompt Library</p>
                    <div className="flex items-center text-sm text-gray-600 mt-2">
                      <img src="/api/placeholder/32/32" alt="User" className="h-5 w-5 rounded-full mr-2" />
                ...
                <div className="flex">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 flex-grow">
                    <div className="flex justify-between">
                      <h3 className="font-medium text-gray-800">Model fallback rules configured</h3>
                      <div className="text-sm text-gray-500">Yesterday, 4:23 PM</div>
                    </div>
                    <p className="text-sm text-gray-600 mt-1">Admin Panel → AI Configuration</p>
                    <div className="flex items-center text-sm text-gray-600 mt-2">
                      <img src="/api/placeholder/32/32" alt="User" className="h-5 w-5 rounded-full mr-2" />
                      <span>Jonathan Miller (Admin)</span>
                      <button className="ml-auto text-xs text-blue-600 border border-blue-200 px-2 py-0.5 rounded-md">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="bg-blue-50 rounded-lg border border-blue-100 p-4 flex flex-col hover:shadow-md transition-shadow">
                  <div className="flex items-center">
                    ...
                    <h3 className="font-medium text-blue-700">User Management</h3>
                  </div>
                ...
                <div className="bg-purple-50 rounded-lg border border-purple-100 p-4 flex flex-col hover:shadow-md transition-shadow">
                  <div className="flex items-center">
                    ...
                    <h3 className="font-medium text-purple-700">Brand Settings</h3>
                  </div>
                  <p className="text-sm text-gray-600 mt-3 mb-4">
                ...
                <div className="bg-green-50 rounded-lg border border-green-100 p-4 flex flex-col hover:shadow-md transition-shadow">
                  <div className="flex items-center">
                    ...
                    <h3 className="font-medium text-green-700">AI Model Config</h3>
                  </div>
                  <p className="text-sm text-gray-600 mt-3 mb-4">
                ...
                <div className="bg-amber-50 rounded-lg border border-amber-100 p-4 flex flex-col hover:shadow-md transition-shadow">
                  <div className="flex items-center">
                    ...
                    <h3 className="font-medium text-amber-700">Export Health</h3>
                  </div>
                  <p className="text-sm text-gray-600 mt-3 mb-4">
            ...
            <div className="w-full mt-6 space-y-3">
              <h2 className="text-xl font-bold text-gray-800">System Warnings</h2>
              ...
              <div className="bg-amber-50 border-l-4 border-amber-500 rounded-md p-4 flex justify-between items-center">
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="font-medium text-amber-800">⚠️ 12% of content failed QA yesterday</p>
                    <p className="text-sm text-amber-700 mt-0.5">
                      Validator detected tone issues across multiple drafts - check Validator rules
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-red-50 border-l-4 border-red-500 rounded-md p-4 flex justify-between items-center">
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="font-medium text-red-800">❌ Slack integration needs re-authentication</p>
                    <p className="text-sm text-red-700 mt-0.5">
                      Token expired 2 hours ago - notifications are not being delivered
                    </p>
                  </div>
                </div>
                <div className="flex items-center space-x-2">
              ...
              <div className="bg-blue-50 border-l-4 border-blue-500 rounded-md p-4 flex justify-between items-center">
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="font-medium text-blue-800">🔔 4 exports pending retries — investigate now</p>
              ...
              <div className="flex justify-between mt-4">
                <button className="flex items-center text-sm text-gray-600">
                  <Clock className="h-4 w-4 mr-1.5" /> Snooze all warnings for 4 hours
                </button>
                <button className="flex items-center text-sm text-blue-600">
                  <ExternalLink className="h-4 w-4 mr-1.5" /> View all system notifications
                </button>
              </div>
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-md mt-4 p-3">
                ...
                <div className="space-y-2">
                  <p className="text-xs text-gray-600">• Katie uploaded 2 new prompts (10 minutes ago)</p>
                  <p className="text-xs text-gray-600">• Vasanth updated tone guardrails (35 minutes ago)</p>
                  <p className="text-xs text-gray-600">• System tone analysis completed for 28 drafts (1 hour ago)</p>
                </div>
              </div>
            </div>
            ...
            <div className="w-full p-6 bg-white rounded-lg shadow mt-6">
              ...
              <div className="bg-blue-50 border border-blue-100 rounded-lg p-4">
                <p className="text-gray-700 mb-3">Ask me anything about system performance or how to optimize your workspace:</p>
            ...
            <div className="w-full p-4 bg-gray-50 border border-gray-200 rounded-lg mt-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <p className="text-sm text-gray-600">Memory Index: 83% healthy | 12% unused | 5% flagged for cleanup</p>
                </div>
            ...
            <div className="mt-10 mb-6 text-center text-sm text-gray-500">
              ...
              <p className="mt-1">Your workspace is using 9 of 10 licenses | <a href="#" className="text-blue-600">Upgrade Plan</a></p>
            </div>
          </div>
        </main>
      </div>
