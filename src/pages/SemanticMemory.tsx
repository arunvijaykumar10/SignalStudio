...
import { Search, Tag, Pin, Clock, Filter, ChevronRight, Save, X, AlertCircle, Edit, Trash, ChevronDown, Check } from 'lucide-react';
...
const SemanticMemoryEngine = () => {
  ...
  const memoryItems = [
    {
      ...
      type: "Text",
      preview: "Welcome to our exclusive spring collection, designed with sustainability in mind...",
    ...
    },
    {
      ...
      type: "Snippet",
      preview: "The latest update brings seamless integration with your favorite tools and faster performance...",
      lastUsed: "Yesterday",
      tone: "Enthusiastic",
    ...
    },
    {
      ...
      type: "Snippet",
      preview: "Investment products may lose value. Past performance is not indicative of future results...",
      lastUsed: "3 days ago",
      tone: "Formal",
      persona: "Legal",
    ...
    },
    {
      ...
      type: "Prompt",
      preview: "We value your feedback! Please take a moment to share your experience with our recent service...",
      lastUsed: "1 week ago",
      tone: "Friendly",
    ...
    },
    {
      ...
      type: "Text",
      preview: "Thank you for reaching out to our support team. I understand you're experiencing an issue with...",
  ...
  const filterOptions = {
    ...
    persona: ["Marketing Lead", "Customer Success", "Legal", "Product Marketing", "Support"],
    tone: ["Professional", "Enthusiastic", "Formal", "Friendly", "Helpful"],
    campaign: ["Spring 2025", "Mobile App Launch", "Financial Services", "Feedback Initiative", "Customer Support"]
  };
    ...
    <div className="flex flex-col h-screen bg-gray-50">
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-white border-b border-gray-200">
        <div className="flex items-center">
          <h2 className="text-lg font-semibold text-gray-800">Semantic Memory Engine</h2>
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <div className="w-1/3 border-r border-gray-200 bg-white flex flex-col">
            ...
            <div className="p-4 border-b border-gray-200">
              ...
              {!searchQuery && (
                <div className="mt-2 px-3 py-2 bg-blue-50 text-blue-700 text-sm rounded-md flex items-start">
                  ...
                  <p>Try "Find last quarter's welcome email intro" or "Show formal tone examples"</p>
                </div>
              )}
            </div>
            ...
            <div className="flex border-b border-gray-200">
              ...
              <button
                className={`flex-1 py-2 text-sm font-medium ${
                  activeTab === 'pinned' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500 hover:text-gray-700'
                }`}
                ...
                filteredItems.map((item) => (
                  ...
                  >
                    <div className="flex justify-between items-start">
                      ...
                      {item.isPinned && <Pin size={14} className="text-blue-600" />}
                    </div>
                    <p className="text-sm text-gray-600 mt-1 line-clamp-2">{item.preview}</p>
                    <div className="flex justify-between items-center mt-2">
                      <div className="flex items-center text-xs text-gray-500">
                        <span className={`px-2 py-0.5 rounded ${
                          item.type === 'Text' ? 'bg-green-100 text-green-800' :
                          item.type === 'Snippet' ? 'bg-purple-100 text-purple-800' :
                      ...
                      <span className="text-xs text-gray-400">{item.lastUsed}</span>
                    </div>
                  </div>
                ))
              )}
            ...
            {selectedItem ? (
                ...
                <div className="p-4 border-b border-gray-200">
                  <div className="flex justify-between items-start">
                    ...
                    <div className="flex space-x-2">
                      ...
                      <button className="p-1.5 rounded hover:bg-gray-100 text-gray-500">
                        <Pin size={18} className={selectedItem.isPinned ? "text-blue-600" : ""} />
                      </button>
                      <button className="p-1.5 rounded hover:bg-gray-100 text-gray-500">
                        <Trash size={18} />
                      </button>
                  ...
                  <div className="flex flex-wrap mt-2 gap-1">
                    {selectedItem.tags.map((tag) => (
                      <span key={tag} className="px-2 py-0.5 bg-gray-100 text-gray-700 text-xs rounded-full flex items-center">
                ...
                <div className="p-4 border-b border-gray-200">
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <p className="font-medium">{selectedItem.usageCount} times</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex-1 flex items-center justify-center bg-gray-50">
                <div className="text-center p-6">
                  ...
                  <h3 className="text-lg font-medium text-gray-700">Select an item to preview</h3>
