...
import { Brain, Search, X, Clock, Star, Filter, Pin, PlusCircle, ExternalLink, Bookmark, Hash, Paperclip } from 'lucide-react';
...
const SemanticMemoryDrawer = () => {
  ...
  const handlePinItem = (item: { id: any; title?: string; type?: string; lastUsed?: string; toneScore?: number; tags?: string[]; }) => {
