...
import { User, Settings, Bell, Upload, Globe, Type, Moon, Menu, Save, Check, Mic, MessageSquare, FileText, Sliders, Lock, ChevronDown, Briefcase, AlertCircle } from 'lucide-react';
    ...
    <div className="bg-gray-50 p-6 min-h-screen">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex mb-6 border-b">
          <div className="px-4 py-2 border-b-2 border-blue-500 text-blue-600 font-medium flex items-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <div className="flex items-center">
                    <span className="bg-blue-100 text-blue-800 text-sm px-3 py-1 rounded-full">Copywriter</span>
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Default Landing Zone</label>
              <select className="w-full p-2 border border-gray-300 rounded-md bg-white">
                <option>Create Zone</option>
                <option>Memory Zone</option>
                <option>Publish Zone</option>
              </select>
              <span className="text-xs text-gray-500">First page you'll see after login</span>
            </div>
            ...
            <div>
              ...
              <span className="text-xs text-gray-500">Accessibility enhancement</span>
            </div>
            ...
            <div>
              ...
              <span className="text-xs text-gray-500">Affects spacing in tables and cards</span>
            </div>
            ...
            <div className="col-span-2">
              ...
              <span className="text-xs text-gray-500 block ml-5">Personal workspace preference</span>
            </div>
          </div>
          
          <div className="mt-4 border-t pt-4">
            <div className="flex justify-between items-center">
              <span className="text-sm text-gray-500">Preview changes immediately</span>
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          ...
          <div className="space-y-6">
            ...
            <div>
              <label className="flex items-center">
                <input type="checkbox" checked className="mr-2" />
                <span className="text-sm font-medium text-gray-700">Sound / Toast Alerts</span>
              </label>
              <span className="text-xs text-gray-500 block ml-5">For in-app desktop popups</span>
            </div>
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          <h2 className="text-lg font-medium mb-4">Connected Accounts & Integrations</h2>
            ...
            <div className="flex justify-between items-center p-3 border rounded-md">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Status: Connected as @sarah.johnson</p>
                </div>
              </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-3 border rounded-md">
              <h3 className="text-sm font-medium text-gray-700">Last Draft Edited</h3>
              <p className="text-lg">Summer Campaign Email</p>
              <p className="text-xs text-gray-500">Today, 11:23 AM</p>
            </div>
            
            <div className="p-3 border rounded-md">
              <h3 className="text-sm font-medium text-gray-700">Approvals Submitted</h3>
            ...
            <div className="p-3 border rounded-md">
              <h3 className="text-sm font-medium text-gray-700">Most Used Prompt</h3>
              <p className="text-lg">Product Description</p>
              <p className="text-xs text-gray-500">Used 12 times</p>
            </div>
            
            <div className="p-3 border rounded-md">
              <h3 className="text-sm font-medium text-gray-700">Active Campaigns</h3>
          ...
          <div className="mt-6 border-t pt-4">
            ...
            <div className="space-y-3">
              <label className="flex items-center">
                <input type="checkbox" checked className="mr-2" />
                <span className="text-sm">AI Personal Assistant: Enable proactive suggestions in chat + editor</span>
              </label>
              
              <label className="flex items-center">
                <input type="checkbox" className="mr-2" />
                <span className="text-sm">Custom Shortcuts Panel: Add/remove dashboard quick links</span>
              </label>
              
              <label className="flex items-center">
                <input type="checkbox" className="mr-2" />
                <span className="text-sm">Mobile Notifications: Enable for companion app</span>
              </label>
            </div>
          </div>
        </div>
