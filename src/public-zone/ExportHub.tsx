...
import { Download, Share2, Eye, Settings, Clock, CheckCircle, AlertCircle } from 'lucide-react';
...
const SignalExportHub = () => {
  ...
  const formatOptions = [
    { id: 'JSON', label: 'JSON', tooltip: 'Best for programmatic use and API integrations' },
    { id: 'HTML', label: 'HTML', tooltip: 'Best for web publishing' },
    { id: 'PDF', label: 'PDF', tooltip: 'Best for document sharing and printing' },
    { id: 'MD', label: 'Markdown', tooltip: 'Best for documentation systems' },
    { id: 'INDD', label: 'InDesign', tooltip: 'Best for print design workflows' }
  ];
  
  const exportHistory = [
    { id: 1, format: 'JSON', fileName: 'Campaign_Summer2025.json', date: 'Today, 10:42 AM', status: 'success' },
    { id: 2, format: 'PDF', fileName: 'Q2_Newsletter.pdf', date: 'Yesterday', status: 'success' },
    { id: 3, format: 'HTML', fileName: 'ProductLaunch_Email.html', date: 'Apr 15, 2025', status: 'failed' }
  ];
  ...
  return (
    <div className="flex flex-col w-full h-full bg-gray-50">
      ...
      <div className="bg-white p-4 border-b border-gray-200">
        ...
        <p className="text-gray-500">Export finalized content in structured formats for use across tools and teams</p>
      </div>
        ...
        <div className="flex-1 bg-white rounded-lg shadow-sm border border-gray-200 flex flex-col">
          <div className="flex justify-between items-center p-4 border-b border-gray-200">
            ...
            <div className="flex items-center gap-2">
              ...
              <button 
                className={`px-3 py-1 rounded-md ${!showRaw ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 text-gray-700'}`}
          ...
          <div className="flex-1 p-4 overflow-auto">
            {!showRaw ? (
              <div className="p-4 border border-gray-200 rounded-md min-h-full">
                <h1 className="text-2xl font-bold mb-4">Summer 2025 Campaign</h1>
                <p className="mb-4">Introducing our newest line of sustainable products designed to make your summer eco-friendly and stylish.</p>
                ...
                <div className="bg-blue-50 p-4 rounded-md border border-blue-200">
                  <p className="text-blue-800 font-medium">Limited time offer: Use code SUMMER25 for 15% off your purchase</p>
                </div>
              </div>
            ) : (
            ...
            {exportHistory.map(item => (
              <div key={item.id} className="p-3 border border-gray-200 rounded-md hover:bg-gray-50">
                <div className="flex justify-between items-start">
                  <span className="font-medium text-gray-800 truncate mr-2">{item.fileName}</span>
                  {item.status === 'success' ? (
